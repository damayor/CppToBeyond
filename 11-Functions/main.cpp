...
void calculateMean(vector<int> &numbers) {
  if (numbers.size() == 0)
...
void calculateSmallest(vector<int> &numbers) {
  if (numbers.size() == 0)
...
void calculateLargest(vector<int> &numbers) {
  if (numbers.size() == 0)
...
int main() {
    ...
    for(;;) {
        ...
        if (selection == 'P' || selection == 'p') {
            ...
            calculateSmallest(numbers);
        } else if (selection == 'L' || selection == 'l') {
            calculateLargest(numbers) ;
